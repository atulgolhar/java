package com.java21days; 
                                    // application displays a string in the center of the frame
import java.awt.*;
...
class TextFramePanel extends JPanel {
    ...
    public void paintComponent(Graphics comp) {
        ...
        int x = (getSize().width = metrics.stringWidth(text)) / 2;      // determines how to center the text
        int y = getSize().height / 2;                                   // determines how to center the text
