package com.java21days;                 // reads and displays records from Yahoo Finace stock quote database
                                        // similar approach as QuoteData.java
import java.sql.*;
    ...
    public void readStocks() {
        String data = "jdbc:derby//localhost:1527/sample";
                try(
                    ...
                    Class.forName("org.apache.derbyljdbc.ClientDriver");
                    ...
                    while (rec.next()) {
                        ...
                        System.out.println("CHANGE\t" + rec.getString(2));
                        System.out.println("LOW:\t" + rec.getString(4));
                        System.out.println("HIGH:\t" + rec.getString(5));
                        System.out.println("PRICEOPEN:\t" + rec.getString(6));
