package com.java21days;                                 // java code to extract stock data from web and 
...
public class QuoteData {
    ...
    public QuoteData(String inTicker) {
        ticker = inTicker;                              // from command line
    }
    
    private String retrieveQuote() {
        StringBuilder builder = new StringBuilder();
        try {
            URL page = new URL(                                 // define specific url
   ...
   public static void main(String[] arguments) {
       ...
       QuoteData qd = new QuoteData(arguments[0]);          // class defined; command line argument input
       String data = qd.retrieveQuote();                    // layered GET request
       qd.storeQuote(data);
   } 
}
