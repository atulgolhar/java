...
public class ComicBooks3 {
    ...
    public static void main(String[] arguments) {
        ...
        Comic3[] comix = new Comic3[5];       // set up collection
        comix[0] = new Comic3("Amazing Spider-Man", "1A", Condition.VERY_FINE, 5_000.00F);
        comix[0].setPrice( (Float) quality.get(comix[0].condition) );
        comix[1] = new Comic3("Incredible Hulk", "181", Condition.NEAR_MINT, 240.00F);
...
class Comic3 {                      // helper class
    ...
    Comic3(String inTitle, String inIssueNumber, Condition inCondition, 
            float inBasePrice) {    // constructor method
