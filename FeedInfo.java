...
public class FeedInfo extends JFrame {
    ...
    private void setLookAndFeel() {
        try {
            ...
            SwingUtilities.updateComponentTreeUI(this);   // note
        } catch (Exception e) {
...
// note to ensure that all components in the user interface reflect sameness
// the SwingUtilities.updateComponentTreeUI method is called
// (this) is the argument which refers to FeedInfo object being created.
