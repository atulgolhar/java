...
/* new operator code --> calls the new object argument constructor*/
...
class Box {
    ...
    public static void main(String[] arguments) {
        ...
        rect.buildBox(new Point(10,10), 50, 50);  //new operator is used as an argument to a method
        rect.printBox();
    }
}
...
single line is more efficent because it does not store an object in a variable that will used 
only once and never needs to be accessed in any subsequent code.
*/
