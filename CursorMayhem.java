package com.java21days;
                        // cursor changes icons depending upon location
import java.awt.*;
...
public class CursorMayhem extends JFrame {
    ...
    public CursorMayhem() {
        ...
        add(wade);
        hansel = new JButton("Hansel");
        add(hansel);
        
        ActionListener act = new ActionListener() {     // begin anonymous inner class
        ...
        harry.addActionListener(act);   // end anonymous inner class
